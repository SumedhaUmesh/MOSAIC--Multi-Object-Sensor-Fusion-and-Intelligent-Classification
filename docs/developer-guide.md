...
Setup, tuning, Foxglove, bags, metrics, and troubleshooting. For a short overview see the [README](../README.md) at the repo root.

## Repository layout

- `docker/`: Dockerfile, Compose, Fast DDS profile, pinned **`docker/requirements.txt`** (YOLO/scientific stack)
- `ros2_ws/src/mosaic_msgs`: custom ROS 2 interfaces
